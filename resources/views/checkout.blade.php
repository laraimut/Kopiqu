                              ...
                              @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <option value="usa">Jakarta</option>
                                        <option value="uk">Bandung</option>
                                        <option value="ger">Yogyakarta</option>
                                        <option value="fra">Bekasi</option>
                                        <option value="ind">Bandung</option>
                                        <option value="aus">Bogor</option>
                                        <option value="bra">Depok</option>
                                        <option value="cana">Tangerang</option>
                                    </select>
                                    </div>
                                    <div class="col-12 mb-3">
                        ...
                        <div class="cart-summary">
                            ...
                            <div class="payment-method">
                                ...
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    ...
                                    <label class="custom-control-label" for="paypal">Bank Transfer<img class="ml-15" src="img/core-img/paypal.png" alt=""></label>
                                </div>
                            </div>
